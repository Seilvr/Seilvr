...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/cooooo'}, },}}
...
--download('https://raw.githubusercontent.com/Seilvr/Seilvr/master/Seilvr.lua','Seilvr.lua')
...
data = {
{
{text = '- قناة السورس', url = 't.me/cooooo'}, 
},
}
}
...
data = {
{
{text = 'Channel Source ،', url = 't.me/cooooo'}, 
},
{
{text = 'Annotations Source', url = 't.me/LARICATEAM'}, 
},
{
{text = 'Communication Source', url = 't.me/sSs_BoT'}, 
},
{
{text = 'Developer Source !', url = 't.me/sSs_sSs'}, 
},
}
}
return LuaTele.sendText(msg_chat_id,msg_id, [[
